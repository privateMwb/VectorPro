...
class Conan(ConanFile):
    ...
    # edited here.
    name = "vectorpro"
    cmake_name = "VectorPro"  # matches project()'s name in the top-level CMakeLists.txt
    version = "1.0.0"

    url = "https://github.com/privateMwb/VectorPro"
    description = "High-performance, header-only dynamic array with configurable growth policy, custom allocator support, and optional modification-event notifications."
    topics = (
        "vector",
        "container",
        "cpp",
    ...
    # header-library, not "library": there's no compiled src/VectorPro/*.cpp
